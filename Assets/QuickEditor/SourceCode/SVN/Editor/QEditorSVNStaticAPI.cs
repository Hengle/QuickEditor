namespace QuickEditor.SVN
{
    ...
    public static class QEditorSVNStaticAPI
    {
        private const string SVNNodeName = "QuickEditor.SVN/";
        private const string SVNAssetNodeName = "Assets/QuickEditor.SVN/";

        [MenuItem(SVNNodeName + "SVN 提交选中", true, 100)]
        public static bool CheckSVNCommit()
        {
            return (Selection.assetGUIDs != null && Selection.assetGUIDs.Length >= 1);
        }

        [MenuItem(SVNNodeName + "SVN 提交选中", false, 100)]
        ...
        [MenuItem(SVNNodeName + "SVN 提交全部", false, 101)]
        ...
        [MenuItem(SVNNodeName + "SVN 更新选中", true, 200)]
        public static bool CheckSVNUpdate()
        {
            return (Selection.assetGUIDs != null && Selection.assetGUIDs.Length >= 1);
        }

        [MenuItem(SVNNodeName + "SVN 更新选中", false, 200)]
        ...
        [MenuItem(SVNNodeName + "SVN 更新全部", false, 201)]
        ...
        [MenuItem(SVNNodeName + "SVN 增加选中", true, 300)]
        public static bool CheckSVNAdd()
        {
            return (Selection.assetGUIDs != null && Selection.assetGUIDs.Length >= 1);
        }

        [MenuItem(SVNNodeName + "SVN 增加选中", false, 300)]
        ...
        [MenuItem(SVNNodeName + "SVN 增加全部", false, 301)]
        ...
        [MenuItem(SVNNodeName + "SVN 锁住选中 ", true, 400)]
        public static bool CheckSVNLock()
        {
            return (Selection.assetGUIDs != null && Selection.assetGUIDs.Length >= 1);
        }

        [MenuItem(SVNNodeName + "SVN 锁住选中 ", false, 400)]
        ...
        [MenuItem(SVNNodeName + "SVN 锁住全部 ", false, 401)]
        ...
        [MenuItem(SVNNodeName + "SVN 解锁选中", true, 500)]
        public static bool CheckSVNUnLock()
        {
            return (Selection.assetGUIDs != null && Selection.assetGUIDs.Length >= 1);
        }

        [MenuItem(SVNNodeName + "SVN 解锁选中", false, 500)]
        ...
        [MenuItem(SVNNodeName + "SVN 解锁全部", false, 501)]
        ...
        [MenuItem(SVNNodeName + "SVN 显示日志", false, 600)]
        ...
        [MenuItem(SVNNodeName + "SVN 全部日志", false, 601)]
        ...
        [MenuItem(SVNNodeName + "SVN 清理副本", false, 602)]
        ...
        [MenuItem(SVNNodeName + "SVN 打开设置", false, 700)]
        ...
        [MenuItem(SVNNodeName + "SVN 打开文档", false, 700)]
