namespace QuickEditor.UnityToolSet
{
    ...
    {
        internal const int CScanNodePriority = 900;
        internal const string CScanNodeName = UnityToolSetConstants.UnityToolSetRootNodeName + "Analyze Scan Toobar/";
        ...
        /// 打印所有
        /// </summary>
        [MenuItem(CScanNodeName + "Scan All Code", false, CScanNodePriority)]
        ...
        /// 忽略无效行
        /// </summary>
        [MenuItem(CScanNodeName + "Scan Ignore Invalid Rows", false, CScanNodePriority)]
        private static void IgnoreInvalid()
        {
            Scan(true);
        }

        private static void Scan(bool ignore)
        {
            //选取
