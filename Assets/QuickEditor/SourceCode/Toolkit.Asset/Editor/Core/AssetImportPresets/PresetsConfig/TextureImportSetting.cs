namespace QuickEditor.Toolkit
{
    ...
    [System.Serializable]
    public class TextureImportSetting : QuickPresetsSetting
    {
        ...
        public override void DrawInnerGUI()
        {
            ...
            if (GenerateMipMaps)
            {
                QuickEditorGUIStaticAPI.IndentBlock(() =>
                {
            ...
            GUILayout.Space(6);
            WrapMode = QuickEditorGUIStaticAPI.EnumPopup<TextureWrapMode>("Wrap Mode", WrapMode);
            QuickEditorGUIStaticAPI.IndentBlock(() =>
            {
                WrapMode_U = QuickEditorGUIStaticAPI.EnumPopup<TextureWrapMode>("U axis", WrapMode_U);
                WrapMode_V = QuickEditorGUIStaticAPI.EnumPopup<TextureWrapMode>("V axis", WrapMode_V);
            });
            FilterMode = QuickEditorGUIStaticAPI.EnumPopup<FilterMode>("Filter Mode", FilterMode);
            QuickEditorGUIStaticAPI.EnumPopup("Filter Mode", FilterMode, ref FilterMode);
            ...
            QuickEditorGUIStaticAPI.DisabledGroup(nextFieldIsDisabled, () =>
            {
            ...
            {
                QuickEditorGUIStaticAPI.Toggle("Use Crunch Compression", ref UseCrunchCompression);
