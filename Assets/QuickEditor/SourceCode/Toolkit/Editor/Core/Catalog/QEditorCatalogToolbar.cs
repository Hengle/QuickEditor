namespace QuickEditor.Toolkit
{
    ...
    internal static class QEditorCatalogToolbar
    {
        ...
        {
            InternalOpenFolder(QEditorPathStaticAPI.PersistentDataPath);
        }
        ...
        {
            InternalOpenFolder(QEditorPathStaticAPI.StreamingAsstesPath);
        }
        ...
        {
            InternalOpenFolder(QEditorPathStaticAPI.AssetsPath);
        }
        ...
        private static void InternalOpenFolder(string folder)
        {
            ...
            switch (Application.platform)
            {
                ...
                default:
                    throw new QEditorException(string.Format("Not support open folder on '{0}' platform.", Application.platform.ToString()));
            }
        }
    }
}
