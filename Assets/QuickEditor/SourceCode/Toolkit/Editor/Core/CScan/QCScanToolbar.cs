namespace QuickEditor.Toolkit
{
    ...
    public class QCScanToolbar
    {
        internal const int CScanNodePriority = 900;
        internal const string CScanNodeName = QEditorDefines.ToolkitRootNodeName + "CScan Toobar/";
        ...
        /// 打印所有
        /// </summary>
        [MenuItem(CScanNodeName + "All", false, CScanNodePriority)]
        ...
        /// 忽略无效行
        /// </summary>
        [MenuItem(CScanNodeName + "Ignore Invalid Rows", false, CScanNodePriority)]
