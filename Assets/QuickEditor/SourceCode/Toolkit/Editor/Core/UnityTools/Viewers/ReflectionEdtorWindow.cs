...
public class ReflectionEdtorWindow : EditorWindow
{
    ...
    private WindowStatus m_status = WindowStatus.AppDomain;
    private Assembly m_currentAssembly;
    private Type m_currentClass;
    private MethodInfo m_currentMethod;

    private string m_searchTmp = "";

    private string m_searchAssemblyContent = "";
    private string m_searchClassContent = "";
    private string m_searchMethodContent = "";
    ...
    private Assembly[] m_asb;
    private Vector2 m_assemvlyPos = Vector2.zero;

    private void AllAssemvlyGUI()
    {
        if (m_asb == null)
        {
    ...
    private void AssemvlyGUI(Assembly assembly)
    {
        ...
        for (int i = 0; i < nameSplitTmp.Length; i++)
        {
            ...
            {
                content += "<color=black>" + nameSplitTmp[i] + "</color> ";
            }
        }
    ...
    private Vector2 m_classSpace = Vector2.zero;

    private void AllClassGUI()
    {
        if (m_currentAssembly != null)
        {
            Type[] types;
    ...
    private void ClassButtonGUI(Type classType)
    {
        GUILayout.BeginHorizontal("box");
    ...
    private string[] toolbarTexts = { "方法", "字段", "属性" };
    ...
    private string m_callContent = "";

    private void AllMethodGUI()
    {
        if (m_currentClass != null)
        {
            m_classSpace = GUILayout.BeginScrollView(m_classSpace);
    ...
    private void MethodGUI(MethodInfo method)
    {
        GUILayout.BeginHorizontal("box");
        ...
        content3 += "<color=#11FF11>" + GetTypeName(method.ReturnType) + "</color> <color=black>" + method.Name + "</color>";
    ...
    private string GenerateCallCode(Assembly ab, Type type, MethodInfo method)
    {
    ...
    private string GetParmPrdfix(ParameterInfo info, bool isHighLight)
    {
        string content = "";
    ...
    private string GetParmPostfix(ParameterInfo info, bool isHighLight)
    {
        string content = "";
    ...
    private string GetDefaultValue(ParameterInfo info)
    {
        string content = "";
    ...
    private string GetTypeName(Type info)
    {
        string content = "";
    ...
    private void FieldGUI(FieldInfo info)
    {
        GUILayout.BeginHorizontal("box");
    ...
    private string GenerateSetValueCode(Assembly assembly, Type type, FieldInfo field)
    {
        string content = "";
    ...
    private void PropertyGUI(PropertyInfo info)
    {
        GUILayout.BeginHorizontal("box");
