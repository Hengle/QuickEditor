namespace QuickEditor.Toolkit
{
    ...
    public class NewScriptWindow : EditorWindow
    {
        ...
        {
            public GUIContent m_WarningContent = new GUIContent(string.Empty, string.Empty);
        ...
        {
            m_ScriptPrescription.m_Lang = (Language)EditorPrefs.GetInt(kLanguageEditorPrefName, 1);
        ...
        private void Create()
        {
            ...
            //if (CanAddComponent())
            //    UnityEditorInternal.InternalEditorUtility.AddScriptComponentUncheckedUndoable(m_GameObjectToAddTo, AssetDatabase.LoadAssetAtPath(TargetPath(), typeof(MonoScript)) as MonoScript);
